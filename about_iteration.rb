...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Carga el primer elemento en 'product', carga el segundo elemento en 'item' y 
    # realiza la operacion del bloque. Si existe argumento, carga este en 'product' y
    # el primer elemento en 'item'.
  end
